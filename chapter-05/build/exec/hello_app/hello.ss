...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Enter your name: " ext-0))) (let ((act-2 (PreludeC-45IO-prim__getStr ext-0))) (PreludeC-45IO-prim__putStr (string-append (string-append "Hello " (string-append act-2 "!")) "\xa;") ext-0)))))
