...
(define Exercises-getLineMaybe (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__getStr ext-0))) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_String act-1 ""))) (cond ((equal? sc0 1) '()) (else (box act-1)))))))
(define Exercises-readToBlank (lambda (ext-0) (let ((act-1 (Exercises-getLineMaybe ext-0))) (if (null? act-1) '() (let ((e-1 (unbox act-1))) (let ((act-2 (Exercises-readToBlank ext-0))) (cons e-1 act-2)))))))
...
(define Exercises-readAndSave (lambda (ext-0) (let ((act-1 (Exercises-readToBlank ext-0))) (let ((act-2 (PreludeC-45IO-prim__getStr ext-0))) (let ((act-3 ((SystemC-45FileC-45ReadWrite-writeFile (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8885) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8885 eta-0)))))) (lambda (u--a) (lambda (arg-9931) (lambda (eta-0) arg-9931))) (lambda (u--b) (lambda (u--a) (lambda (arg-9937) (lambda (arg-9944) (lambda (world-4) (let ((act-5 (arg-9937 world-4))) (let ((act-3 (arg-9944 world-4))) (act-5 act-3))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-10411) (lambda (arg-10414) (lambda (world-0) (let ((act-3 (arg-10411 world-0))) ((arg-10414 act-3) world-0))))))) (lambda (u--a) (lambda (arg-10425) (lambda (world-0) (let ((act-3 (arg-10425 world-0))) (act-3 world-0)))))) (lambda (u--a) (lambda (arg-13095) arg-13095))) act-2 (DataC-45String-fastUnlines act-1)) ext-0))) (case (vector-ref act-3 0) ((1) (vector 0 )) (else (let ((e-5 (vector-ref act-3 1))) (PreludeC-45IO-prim__putStr (string-append (SystemC-45FileC-45Error-u--show_Show_FileError e-5) "\xa;") ext-0)))))))))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (Exercises-readAndSave eta-0)))
  (collect 4)
