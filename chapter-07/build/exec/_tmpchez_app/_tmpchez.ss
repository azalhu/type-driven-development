...
(define Show-u--show_Show_Album (lambda (arg-0) (let ((e-0 (vector-ref arg-0 0))) (let ((e-1 (vector-ref arg-0 1))) (let ((e-2 (vector-ref arg-0 2))) (string-append e-1 (string-append " by " (string-append e-0 (string-append " (released " (string-append (PreludeC-45Show-u--show_Show_Integer e-2) ")"))))))))))
(define Show-u--showPrec_Show_Album (lambda (arg-0 arg-1) (Show-u--show_Show_Album arg-1)))
(define Show-u--__Impl_Show_Album (cons (lambda (u--x) (Show-u--show_Show_Album u--x)) (lambda (u--d) (lambda (u--x) (Show-u--showPrec_Show_Album u--d u--x)))))
(define Ord-hunkydory (vector "David Bowie" "Hunky Dory" 1971))
...
(PrimIO-unsafePerformIO (PreludeC-45IO-printLn (PreludeC-45IO-u--__Impl_HasIO_C-36io PreludeC-45IO-u--__Impl_HasLinearIO_IO) Show-u--__Impl_Show_Album Ord-hunkydory))
  (collect 4)
