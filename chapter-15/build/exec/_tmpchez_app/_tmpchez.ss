...
(define csegen-8 (vector (lambda (arg-5904) (lambda (arg-5907) (+ arg-5904 arg-5907))) (lambda (arg-5914) (lambda (arg-5917) (* arg-5914 arg-5917))) (lambda (arg-5924) (PreludeC-45Types-prim__integerToNat arg-5924))))
...
(define ProcessLinear-getCountC-39 (lambda (arg-0 arg-1 ext-0) (let ((act-1 (let ((e-0 (car arg-1))) (e-0 ext-0)))) (let ((sc0 (DataC-45String-parsePositive csegen-8 act-1))) (if (null? sc0) (PreludeC-45IO-u--map_Functor_IO (lambda (eta-0) '()) (arg-0 (vector 0 (PreludeC-45Types-u--foldMap_Foldable_List csegen-5 (lambda (eta-0) eta-0) (cons "Not positive: " (cons act-1 '()))))) ext-0) (let ((e-2 (unbox sc0))) (box e-2)))))))
...
(define ProcessLinear-progC-39 (lambda (arg-0 arg-1 ext-0) (let ((act-1 (let ((e-1 (cdr arg-1))) ((e-1 "Please enter the number of lines to read.") ext-0)))) (let ((act-2 (ProcessLinear-getCountC-39 arg-0 arg-1 ext-0))) (if (null? act-2) (vector 0 ) (let ((e-1 (unbox act-2))) (let ((act-3 (let ((e-2 (cdr arg-1))) ((e-2 (PreludeC-45Types-u--foldMap_Foldable_List csegen-5 (lambda (eta-0) eta-0) (cons "Please enter " (cons (PreludeC-45Show-u--show_Show_Nat e-1) (cons " " (cons (let ((sc2 (or (and (= e-1 1) 1) 0))) (cond ((equal? sc2 1) "line") (else "lines"))) (cons " of text." '()))))))) ext-0)))) (let ((act-4 ((ProcessLinear-getTextC-39 arg-0 arg-1 e-1) ext-0))) (let ((e-2 (cdr arg-1))) ((e-2 (PreludeC-45Types-u--foldMap_Foldable_List csegen-5 (lambda (eta-0) eta-0) (cons "Read " (cons (PreludeC-45Show-u--show_Show_Nat e-1) (cons " " (cons (let ((sc2 (or (and (= e-1 1) 1) 0))) (cond ((equal? sc2 1) "line") (else "lines"))) (cons " and " (cons (PreludeC-45Show-u--show_Show_Nat (PreludeC-45Interfaces-sum csegen-8 csegen-24 (DataC-45Vect-u--map_Functor_C-40VectC-32C-36nC-41 (lambda (eta-0) (PreludeC-45TypesC-45String-length eta-0)) act-4))) (cons " characters." '()))))))))) ext-0))))))))))
(define Builtin-fst (lambda (arg-2) (let ((e-2 (car arg-2))) e-2)))
(define ProcessLinear-initServices (lambda (ext-0) ProcessLinear-services))
(define Builtin-snd (lambda (arg-2) (let ((e-3 (cdr arg-2))) e-3)))
(define ProcessLinear-main (lambda (ext-0) (let ((act-1 (ProcessLinear-initServices ext-0))) (ProcessLinear-progC-39 (Builtin-fst act-1) (Builtin-snd act-1) ext-0))))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (ProcessLinear-main eta-0)))
  (collect 4)
