...
(define Main-n--4906-5775-u--addToData (lambda (arg-0 arg-1 arg-2 arg-4) (if (null? arg-4) (cons arg-2 '()) (let ((e-3 (car arg-4))) (let ((e-4 (cdr arg-4))) (cons e-3 (Main-n--4906-5775-u--addToData arg-0 arg-1 arg-2 e-4)))))))
...
(define Main-searchString (lambda (arg-1 arg-2 arg-3) (if (null? arg-2) "" (let ((e-3 (car arg-2))) (let ((e-4 (cdr arg-2))) (let ((u--rest (Main-searchString arg-1 e-4 arg-3))) (let ((sc1 (DataC-45String-isInfixOf arg-3 e-3))) (cond ((equal? sc1 1) (string-append (PreludeC-45Show-u--show_Show_Nat arg-1) (string-append ": " (string-append e-3 (string-append "\xa;" u--rest))))) (else u--rest)))))))))
(define Main-addToStore (lambda (arg-0 arg-1) (let ((e-0 (car arg-0))) (let ((e-1 (cdr arg-0))) (cons (+ e-0 1) (Main-n--4906-5775-u--addToData e-0 e-1 arg-1 e-1))))))
...
(define Main-getEntry (lambda (arg-0 arg-1) (let ((sc0 (DataC-45Fin-integerToFin arg-0 (Main-size arg-1)))) (if (null? sc0) (box (cons "Index out of range" arg-1)) (let ((e-2 (unbox sc0))) (box (cons (DataC-45Vect-index e-2 (Main-items arg-1)) arg-1)))))))
...
(define Main-parseCommand (lambda (arg-0 arg-1) (cond ((equal? arg-0 "add") (box (vector 0 arg-1))) ((equal? arg-0 "get") (let ((sc1 (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8474) (lambda (arg-8477) (PreludeC-45InterfacesC-45BoolC-45Semigroup-u--C-60C-43C-62_Semigroup_AllBool arg-8474 arg-8477))) 1) (lambda (eta-0) (PreludeC-45Types-isDigit eta-0)) (PreludeC-45Types-fastUnpack arg-1)))) (cond ((equal? sc1 0) '()) (else (box (vector 1 (cast-string-int arg-1))))))) ((equal? arg-0 "search") (box (vector 2 arg-1))) ((equal? arg-0 "size") (cond ((equal? arg-1 "") (box (vector 3 )))(else '()))) ((equal? arg-0 "quit") (cond ((equal? arg-1 "") (box (vector 4 )))(else '())))(else '()))))
...
(define Main-processInput (lambda (arg-0 arg-1) (let ((sc0 (Main-parse arg-1))) (if (null? sc0) (box (cons "Invalid command" arg-0)) (let ((e-2 (unbox sc0))) (case (vector-ref e-2 0) ((0) (let ((e-3 (vector-ref e-2 1))) (box (cons (string-append "ID " (PreludeC-45Show-u--show_Show_Nat (Main-size arg-0))) (Main-addToStore arg-0 e-3))))) ((1) (let ((e-4 (vector-ref e-2 1))) (Main-getEntry e-4 arg-0))) ((2) (let ((e-5 (vector-ref e-2 1))) (box (cons (Main-searchString 0 (Main-items arg-0) e-5) arg-0)))) ((3) (box (cons (PreludeC-45Show-u--show_Show_Nat (Main-size arg-0)) arg-0))) (else '())))))))
(define Main-process (lambda (arg-0 arg-1) (let ((sc0 (Main-processInput arg-0 arg-1))) (if (null? sc0) '() (let ((e-2 (unbox sc0))) (let ((e-5 (car e-2))) (let ((e-6 (cdr e-2))) (box (cons (string-append e-5 "\xa;") e-6)))))))))
...
(define SystemC-45REPL-replWith (lambda (arg-2 arg-3 arg-4 arg-5) (let ((e-1 (car arg-2))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (SystemC-45FileC-45ReadWrite-fEOF arg-2 SystemC-45FileC-45Virtual-stdin)) (lambda (u--eof) (cond ((equal? u--eof 1) (let ((e-7 (car arg-2))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) (vector 0 )))))) (else (let ((e-7 (car arg-2))) (let ((e-9 (vector-ref e-7 1))) ((((e-9 'erased) 'erased) (let ((e-11 (cdr arg-2))) ((e-11 'erased) (lambda (eta-0) (PreludeC-45IO-prim__putStr arg-4 eta-0))))) (lambda (_-10649) (let ((e-12 (car arg-2))) (let ((e-14 (vector-ref e-12 1))) ((((e-14 'erased) 'erased) (SystemC-45FileC-45Process-fflush arg-2 SystemC-45FileC-45Virtual-stdout)) (lambda (_-10650) (let ((e-17 (car arg-2))) (let ((e-19 (vector-ref e-17 1))) ((((e-19 'erased) 'erased) (let ((e-21 (cdr arg-2))) ((e-21 'erased) (lambda (eta-0) (PreludeC-45IO-prim__getStr eta-0))))) (lambda (u--x) (let ((sc5 ((arg-5 arg-3) u--x))) (if (null? sc5) (let ((e-22 (car arg-2))) (let ((e-25 (vector-ref e-22 0))) (let ((e-27 (vector-ref e-25 1))) ((e-27 'erased) (vector 0 ))))) (let ((e-21 (unbox sc5))) (let ((e-23 (car e-21))) (let ((e-22 (cdr e-21))) (let ((e-25 (car arg-2))) (let ((e-27 (vector-ref e-25 1))) ((((e-27 'erased) 'erased) (let ((e-29 (cdr arg-2))) ((e-29 'erased) (lambda (eta-0) (PreludeC-45IO-prim__putStr e-23 eta-0))))) (lambda (_-10651) (SystemC-45REPL-replWith arg-2 e-22 arg-4 arg-5))))))))))))))))))))))))))))))
(define PreludeC-45IO-u--map_Functor_IO (lambda (arg-2 arg-3 ext-0) (let ((act-2 (arg-3 ext-0))) (arg-2 act-2))))
(define Main-main (lambda () (SystemC-45REPL-replWith (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8885) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8885 eta-0)))))) (lambda (u--a) (lambda (arg-9931) (lambda (eta-0) arg-9931))) (lambda (u--b) (lambda (u--a) (lambda (arg-9937) (lambda (arg-9944) (lambda (world-4) (let ((act-5 (arg-9937 world-4))) (let ((act-3 (arg-9944 world-4))) (act-5 act-3))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-10411) (lambda (arg-10414) (lambda (world-0) (let ((act-1 (arg-10411 world-0))) ((arg-10414 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10425) (lambda (world-0) (let ((act-1 (arg-10425 world-0))) (act-1 world-0)))))) (lambda (u--a) (lambda (arg-13095) arg-13095))) (cons 0 '()) "Command: " (lambda (eta-0) (lambda (eta-1) (Main-process eta-0 eta-1))))))
