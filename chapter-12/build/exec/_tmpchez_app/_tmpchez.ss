...
(define ArithState-with--runCommandC-44getRandom-1700 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5) (cond ((equal? arg-3 0) (case (vector-ref arg-5 0) ((0) 1)(else (let ((e-2 (vector-ref arg-5 2))) (bs+ (PreludeC-45Num-u--abs_Abs_Int e-2) 1 63)))))(else (let ((e-2 (vector-ref arg-5 2))) (bs+ (PreludeC-45Num-u--abs_Abs_Int e-2) 1 63))))))
...
(define DataC-45PrimitivesC-45ViewsC-45IntV-divides (lambda (arg-0 arg-1) (cond ((equal? arg-1 0) (vector 0 ))(else (let ((u--dividend (let ((sc0 (PreludeC-45EqOrd-u--C-60_Ord_Int arg-1 (blodwen-toSignedInt 0 63)))) (cond ((equal? sc0 1) (bs- 0 (PreludeC-45Num-u--div_Integral_Int arg-0 (PreludeC-45Num-u--abs_Abs_Int arg-1)) 63)) (else (PreludeC-45Num-u--div_Integral_Int arg-0 arg-1)))))) (let ((u--remainder (PreludeC-45Num-u--abs_Abs_Int (bs- arg-0 (bs* u--dividend arg-1 63) 63)))) (vector 1 u--dividend u--remainder (vector 0 ))))))))
(define ArithState-n--5520-1688-u--getRandom (lambda (arg-0 arg-1 arg-2 arg-4 arg-5) (ArithState-with--runCommandC-44getRandom-1700 arg-4 arg-1 arg-2 arg-5 arg-4 (DataC-45PrimitivesC-45ViewsC-45IntV-divides arg-4 arg-5))))
...
(define ArithState-u--show_Show_Score (lambda (arg-0) (string-append (PreludeC-45Show-u--show_Show_Nat (let ((e-0 (car arg-0))) e-0)) (string-append "/" (PreludeC-45Show-u--show_Show_Nat (let ((e-1 (cdr arg-0))) e-1))))))
...
(define ArithState-u--show_Show_GameState (lambda (arg-0) (string-append (ArithState-u--show_Show_Score (let ((e-0 (car arg-0))) e-0)) (string-append "\xa;" (string-append "Difficulty: " (PreludeC-45Show-u--show_Show_Int (let ((e-1 (cdr arg-0))) e-1)))))))
(define ArithState-u--C-62C-62C-61_Monad_Command (lambda (ext-0 ext-1) (vector 6 ext-0 ext-1)))
(define ArithStateC-45ConsoleDo-C-62C-62 (lambda (ext-0 ext-1) (vector 2 ext-0 ext-1)))
(define ArithStateC-45ConsoleDo-C-62C-62C-61 (lambda (ext-0 ext-1) (vector 1 ext-0 ext-1)))
(define ArithState-addWrong (lambda (ext-0) (let ((e-0 (car ext-0))) (let ((e-1 (cdr ext-0))) (let ((e-2 (car e-0))) (let ((e-3 (cdr e-0))) (cons (cons e-2 (+ e-3 1)) e-1)))))))
(define ArithState-addCorrect (lambda (ext-0) (let ((e-0 (car ext-0))) (let ((e-1 (cdr ext-0))) (let ((e-2 (car e-0))) (let ((e-3 (cdr e-0))) (cons (cons (+ e-2 1) (+ e-3 1)) e-1)))))))
(define ArithState-correct (lambda () (ArithStateC-45ConsoleDo-C-62C-62C-61 (vector 3 ) (lambda (u--st) (lambda () (ArithStateC-45ConsoleDo-C-62C-62 (vector 0 "Correct!\xa;") (lambda () (ArithStateC-45ConsoleDo-C-62C-62 (vector 4 (ArithState-addCorrect u--st)) (lambda () (ArithState-quiz))))))))))
...
(define ArithState-readInput (lambda (arg-0) (ArithState-u--C-62C-62C-61_Monad_Command (vector 0 arg-0) (lambda (_-10649) (ArithState-u--C-62C-62C-61_Monad_Command (vector 1 ) (lambda (u--answer) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_String (DataC-45String-toLower u--answer) "quit"))) (cond ((equal? sc0 1) (vector 5 '())) (else (vector 5 (box (cast-string-boundedInt u--answer 63))))))))))))
(define ArithState-quiz (lambda () (ArithStateC-45ConsoleDo-C-62C-62C-61 (vector 2 ) (lambda (u--num1) (lambda () (ArithStateC-45ConsoleDo-C-62C-62C-61 (vector 2 ) (lambda (u--num2) (lambda () (ArithStateC-45ConsoleDo-C-62C-62C-61 (vector 3 ) (lambda (u--st) (lambda () (ArithStateC-45ConsoleDo-C-62C-62 (vector 0 (string-append (ArithState-u--show_Show_GameState u--st) "\xa;")) (lambda () (ArithStateC-45ConsoleDo-C-62C-62C-61 (ArithState-readInput (string-append (PreludeC-45Show-u--show_Show_Int u--num1) (string-append " * " (string-append (PreludeC-45Show-u--show_Show_Int u--num2) "? ")))) (lambda (u--input) (if (null? u--input) (lambda () (vector 0 u--st)) (let ((e-0 (unbox u--input))) (let ((u--correct_answer (bs* u--num1 u--num2 63))) (let ((sc1 (PreludeC-45EqOrd-u--C-61C-61_Eq_Int e-0 u--correct_answer))) (cond ((equal? sc1 1) (lambda () (ArithState-correct))) (else (lambda () (ArithState-wrong u--correct_answer)))))))))))))))))))))))
(define ArithState-wrong (lambda (arg-0) (ArithStateC-45ConsoleDo-C-62C-62C-61 (vector 3 ) (lambda (u--st) (lambda () (ArithStateC-45ConsoleDo-C-62C-62 (vector 0 (string-append "Wrong, the answer is " (string-append (PreludeC-45Show-u--show_Show_Int arg-0) "\xa;"))) (lambda () (ArithStateC-45ConsoleDo-C-62C-62 (vector 4 (ArithState-addWrong u--st)) (lambda () (ArithState-quiz))))))))))
(define ArithState-runCommand (lambda (arg-1 arg-2 arg-3) (case (vector-ref arg-3 0) ((0) (let ((e-10 (vector-ref arg-3 1))) (lambda (world-0) (let ((act-1 (PreludeC-45IO-prim__putStr e-10 world-0))) (cons (vector 0 ) (cons arg-1 arg-2)))))) ((1) (lambda (world-0) (let ((act-1 (PreludeC-45IO-prim__getStr world-0))) (cons act-1 (cons arg-1 arg-2)))))(else (lambda (clam-0) (if (null? arg-1) (case (vector-ref arg-3 0) ((3) (cons arg-2 (cons arg-1 arg-2))) ((4) (let ((e-0 (vector-ref arg-3 1))) (cons (vector 0 ) (cons arg-1 e-0)))) ((5) (let ((e-2 (vector-ref arg-3 1))) (cons e-2 (cons arg-1 arg-2)))) (else (let ((e-5 (vector-ref arg-3 1))) (let ((e-6 (vector-ref arg-3 2))) (let ((act-1 ((ArithState-runCommand arg-1 arg-2 e-5) clam-0))) (let ((e-2 (car act-1))) (let ((e-3 (cdr act-1))) (let ((e-8 (car e-3))) (let ((e-7 (cdr e-3))) ((ArithState-runCommand e-8 e-7 (e-6 e-2)) clam-0)))))))))) (let ((e-8 (car arg-1))) (let ((e-9 (cdr arg-1))) (case (vector-ref arg-3 0) ((2) (cons (ArithState-n--5520-1688-u--getRandom e-8 e-9 arg-2 e-8 (let ((e-1 (cdr arg-2))) e-1)) (cons (e-9) arg-2)))(else (case (vector-ref arg-3 0) ((3) (cons arg-2 (cons arg-1 arg-2))) ((4) (let ((e-0 (vector-ref arg-3 1))) (cons (vector 0 ) (cons arg-1 e-0)))) ((5) (let ((e-2 (vector-ref arg-3 1))) (cons e-2 (cons arg-1 arg-2)))) (else (let ((e-5 (vector-ref arg-3 1))) (let ((e-6 (vector-ref arg-3 2))) (let ((act-1 ((ArithState-runCommand arg-1 arg-2 e-5) clam-0))) (let ((e-2 (car act-1))) (let ((e-3 (cdr act-1))) (let ((e-10 (car e-3))) (let ((e-7 (cdr e-3))) ((ArithState-runCommand e-10 e-7 (e-6 e-2)) clam-0))))))))))))))))))))
(define ArithState-run (lambda (arg-1 arg-2 arg-3 arg-4) (if (null? arg-1) (lambda (eta-0) (cons '() (cons arg-2 arg-3))) (lambda (clam-0) (case (vector-ref arg-4 0) ((0) (let ((e-9 (vector-ref arg-4 1))) (cons (box e-9) (cons arg-2 arg-3))))(else (let ((e-0 (unbox arg-1))) (case (vector-ref arg-4 0) ((1) (let ((e-3 (vector-ref arg-4 1))) (let ((e-4 (vector-ref arg-4 2))) (let ((act-1 ((ArithState-runCommand arg-2 arg-3 e-3) clam-0))) (let ((e-2 (car act-1))) (let ((e-5 (cdr act-1))) (let ((e-6 (car e-5))) (let ((e-7 (cdr e-5))) ((ArithState-run (e-0) e-6 e-7 ((e-4 e-2))) clam-0))))))))) (else (let ((e-6 (vector-ref arg-4 1))) (let ((e-7 (vector-ref arg-4 2))) (let ((act-1 ((ArithState-runCommand arg-2 arg-3 e-6) clam-0))) (let ((e-3 (cdr act-1))) (let ((e-9 (car e-3))) (let ((e-8 (cdr e-3))) ((ArithState-run (e-0) e-9 e-8 (e-7)) clam-0))))))))))))))))
(define ArithState-randoms (lambda (arg-0) (let ((u--seedC-39 (bs+ (bs* (blodwen-toSignedInt 1664525 63) arg-0 63) (blodwen-toSignedInt 1013904223 63) 63))) (cons (blodwen-shr u--seedC-39 (blodwen-toSignedInt 2 63)) (lambda () (ArithState-randoms u--seedC-39))))))
(define ArithState-forever (lambda () (box (lambda () (ArithState-forever)))))
(define ArithState-initState (cons (cons 0 0) 12))
...
(define ArithState-main (lambda (ext-0) (let ((act-1 ((System-time (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8885) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8885 eta-0)))))) (lambda (u--a) (lambda (arg-9931) (lambda (eta-0) arg-9931))) (lambda (u--b) (lambda (u--a) (lambda (arg-9937) (lambda (arg-9944) (lambda (world-4) (let ((act-5 (arg-9937 world-4))) (let ((act-3 (arg-9944 world-4))) (act-5 act-3))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-10411) (lambda (arg-10414) (lambda (world-0) (let ((act-1 (arg-10411 world-0))) ((arg-10414 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10425) (lambda (world-0) (let ((act-1 (arg-10425 world-0))) (act-1 world-0)))))) (lambda (u--a) (lambda (arg-13095) arg-13095)))) ext-0))) (let ((act-2 ((ArithState-run (ArithState-forever) (ArithState-randoms (blodwen-toSignedInt act-1 63)) ArithState-initState (ArithState-quiz)) ext-0))) (if (null? act-2) (PreludeC-45IO-prim__putStr "Ran out of fuel\xa;" ext-0) (let ((e-2 (car act-2))) (let ((e-3 (cdr act-2))) (if (null? e-2) (PreludeC-45IO-prim__putStr "Ran out of fuel\xa;" ext-0) (let ((e-5 (unbox e-2))) (if (null? e-3) (PreludeC-45IO-prim__putStr "Ran out of fuel\xa;" ext-0) (PreludeC-45IO-prim__putStr (string-append (string-append "Final score: " (ArithState-u--show_Show_GameState e-5)) "\xa;") ext-0)))))))))))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (ArithState-main eta-0)))
  (collect 4)
