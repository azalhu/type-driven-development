...
(define Average-n--3710-2542-u--allLengths (lambda (arg-0 arg-1) (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (PreludeC-45TypesC-45String-length eta-0)) arg-1)))
...
(define Average-n--3710-2543-u--wordCount (lambda (arg-0 arg-1) (PreludeC-45TypesC-45List-lengthTR (DataC-45String-words arg-1))))
(define Average-average (lambda (arg-0) (let ((u--numWords (Average-n--3710-2543-u--wordCount arg-0 arg-0))) (let ((u--totalLength (PreludeC-45Interfaces-sum (vector (lambda (arg-5904) (lambda (arg-5907) (+ arg-5904 arg-5907))) (lambda (arg-5914) (lambda (arg-5917) (* arg-5914 arg-5917))) (lambda (arg-5924) (PreludeC-45Types-prim__integerToNat arg-5924))) (vector (lambda (u--acc) (lambda (u--elem) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldr_Foldable_List u--func u--init u--input)))))) (lambda (u--elem) (lambda (u--acc) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldl_Foldable_List u--func u--init u--input)))))) (lambda (u--elem) (lambda (arg-10911) (PreludeC-45Types-u--null_Foldable_List arg-10911))) (lambda (u--elem) (lambda (u--acc) (lambda (u--m) (lambda (i_con-0) (lambda (u--funcM) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldlM_Foldable_List i_con-0 u--funcM u--init u--input)))))))) (lambda (u--elem) (lambda (arg-10940) arg-10940)) (lambda (u--a) (lambda (u--m) (lambda (i_con-0) (lambda (u--f) (lambda (arg-10954) (PreludeC-45Types-u--foldMap_Foldable_List i_con-0 u--f arg-10954))))))) (Average-n--3710-2542-u--allLengths arg-0 (DataC-45String-words arg-0))))) (/ (exact->inexact u--totalLength) (exact->inexact u--numWords))))))
...
(define Main-showAverage (lambda (arg-0) (string-append "The average word length is: " (string-append (PreludeC-45Show-u--show_Show_Double (Average-average arg-0)) "\xa;"))))
