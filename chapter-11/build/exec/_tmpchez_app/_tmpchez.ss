...
(define ArithCmdDo-with--arithInputsC-44bound-1809 (lambda (arg-0 arg-1 arg-2) (let ((e-2 (vector-ref arg-2 2))) (bs+ e-2 1 63))))
...
(define ArithCmdDo-n--5701-1798-u--bound (lambda (arg-0 arg-1) (ArithCmdDo-with--arithInputsC-44bound-1809 arg-0 arg-1 (DataC-45PrimitivesC-45ViewsC-45IntV-divides arg-1 12))))
...
(define ArithCmdDo-u--show_Show_QuizState (lambda (arg-0) (string-append (PreludeC-45Show-u--show_Show_Nat (let ((e-0 (car arg-0))) e-0)) (string-append " / " (PreludeC-45Show-u--show_Show_Nat (let ((e-1 (cdr arg-0))) e-1))))))
(define ArithCmdDo-u--C-62C-62C-61_Monad_Command (lambda (ext-0 ext-1) (vector 3 ext-0 ext-1)))
(define ArithCmdDoC-45ConsoleDo-C-62C-62 (lambda (ext-0 ext-1) (vector 2 ext-0 ext-1)))
(define ArithCmdDoC-45ConsoleDo-C-62C-62C-61 (lambda (ext-0 ext-1) (vector 1 ext-0 ext-1)))
(define ArithCmdDo-correct (lambda (arg-0 arg-1) (let ((e-0 (car arg-1))) (let ((e-1 (cdr arg-1))) (ArithCmdDoC-45ConsoleDo-C-62C-62 (vector 0 "Correct!\xa;") (lambda () (ArithCmdDo-quiz arg-0 (cons (+ e-0 1) (+ e-1 1)))))))))
...
(define ArithCmdDo-readInput (lambda (arg-0) (ArithCmdDo-u--C-62C-62C-61_Monad_Command (vector 0 arg-0) (lambda (_-10649) (ArithCmdDo-u--C-62C-62C-61_Monad_Command (vector 1 ) (lambda (u--answer) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_String (DataC-45String-toLower u--answer) "quit"))) (cond ((equal? sc0 1) (vector 2 '())) (else (vector 2 (box (cast-string-boundedInt u--answer 63))))))))))))
...
(define ArithCmdDo-quiz (lambda (arg-0 arg-1) (let ((e-1 (car arg-0))) (let ((e-2 (cdr arg-0))) (let ((e-4 (e-2))) (let ((e-6 (car e-4))) (let ((e-7 (cdr e-4))) (ArithCmdDoC-45ConsoleDo-C-62C-62 (vector 0 (string-append "Score so far: " (string-append (ArithCmdDo-u--show_Show_QuizState arg-1) "\xa;"))) (lambda () (ArithCmdDoC-45ConsoleDo-C-62C-62C-61 (ArithCmdDo-readInput (string-append (PreludeC-45Show-u--show_Show_Int e-1) (string-append " * " (string-append (PreludeC-45Show-u--show_Show_Int e-6) "? ")))) (lambda (u--input) (if (null? u--input) (lambda () (vector 0 arg-1)) (let ((e-0 (unbox u--input))) (let ((sc3 (PreludeC-45EqOrd-u--C-61C-61_Eq_Int e-0 (bs* e-1 e-6 63)))) (cond ((equal? sc3 1) (lambda () (ArithCmdDo-correct (e-7) arg-1))) (else (lambda () (ArithCmdDo-wrong (e-7) (bs* e-1 e-6 63) arg-1))))))))))))))))))
(define ArithCmdDo-wrong (lambda (arg-0 arg-1 arg-2) (let ((e-0 (car arg-2))) (let ((e-1 (cdr arg-2))) (ArithCmdDoC-45ConsoleDo-C-62C-62 (vector 0 (string-append "Wrong, the answer is " (string-append (PreludeC-45Show-u--show_Show_Int arg-1) "\xa;"))) (lambda () (ArithCmdDo-quiz arg-0 (cons e-0 (+ e-1 1)))))))))
(define ArithCmdDo-runCommand (lambda (arg-1 ext-0) (case (vector-ref arg-1 0) ((0) (let ((e-0 (vector-ref arg-1 1))) (PreludeC-45IO-prim__putStr e-0 ext-0))) ((1) (PreludeC-45IO-prim__getStr ext-0)) ((2) (let ((e-2 (vector-ref arg-1 1))) e-2)) (else (let ((e-5 (vector-ref arg-1 1))) (let ((e-6 (vector-ref arg-1 2))) (let ((act-1 (ArithCmdDo-runCommand e-5 ext-0))) (ArithCmdDo-runCommand (e-6 act-1) ext-0))))))))
(define ArithCmdDo-run (lambda (arg-1 arg-2) (if (null? arg-1) (lambda (eta-0) '()) (lambda (clam-0) (case (vector-ref arg-2 0) ((0) (let ((e-9 (vector-ref arg-2 1))) (box e-9)))(else (let ((e-0 (unbox arg-1))) (case (vector-ref arg-2 0) ((1) (let ((e-3 (vector-ref arg-2 1))) (let ((e-4 (vector-ref arg-2 2))) (let ((act-1 (ArithCmdDo-runCommand e-3 clam-0))) ((ArithCmdDo-run (e-0) ((e-4 act-1))) clam-0))))) (else (let ((e-6 (vector-ref arg-2 1))) (let ((e-7 (vector-ref arg-2 2))) (let ((act-1 (ArithCmdDo-runCommand e-6 clam-0))) ((ArithCmdDo-run (e-0) (e-7)) clam-0)))))))))))))
(define ArithCmdDo-randoms (lambda (arg-0) (let ((u--seedC-39 (bs+ (bs* (blodwen-toSignedInt 1664525 63) arg-0 63) (blodwen-toSignedInt 1013904223 63) 63))) (cons (blodwen-shr u--seedC-39 (blodwen-toSignedInt 2 63)) (lambda () (ArithCmdDo-randoms u--seedC-39))))))
(define PreludeC-45Types-u--map_Functor_Stream (lambda (arg-2 arg-3) (let ((e-1 (car arg-3))) (let ((e-2 (cdr arg-3))) (cons (arg-2 e-1) (lambda () (PreludeC-45Types-u--map_Functor_Stream arg-2 (e-2))))))))
(define ArithCmdDo-arithInputs (lambda (arg-0) (PreludeC-45Types-u--map_Functor_Stream (lambda (eta-0) (ArithCmdDo-n--5701-1798-u--bound arg-0 eta-0)) (ArithCmdDo-randoms arg-0))))
(define ArithCmdDo-forever (lambda () (box (lambda () (ArithCmdDo-forever)))))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (ArithCmdDo-main eta-0)))
  (collect 4)
