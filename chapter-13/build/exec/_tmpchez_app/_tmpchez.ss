...
(define StackIOC-45StackDo-C-62C-62 (lambda (ext-0 ext-1) (vector 1 ext-0 ext-1)))
(define StackIOC-45StackDo-C-62C-62C-61 (lambda (ext-0 ext-1) (vector 0 ext-0 ext-1)))
(define StackIO-doSubtract (vector 6 (vector 1 ) (lambda (u--val1) (vector 6 (vector 1 ) (lambda (u--val2) (vector 0 (- u--val2 u--val1)))))))
...
(define StackIO-strToInput (lambda (arg-0) (cond ((equal? arg-0 "") '()) ((equal? arg-0 "add") (box (vector 1 ))) ((equal? arg-0 "subtract") (box (vector 2 ))) ((equal? arg-0 "multiply") (box (vector 3 ))) ((equal? arg-0 "negate") (box (vector 4 ))) ((equal? arg-0 "discard") (box (vector 5 ))) ((equal? arg-0 "duplicate") (box (vector 6 )))(else (let ((sc0 (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8474) (lambda (arg-8477) (PreludeC-45InterfacesC-45BoolC-45Semigroup-u--C-60C-43C-62_Semigroup_AllBool arg-8474 arg-8477))) 1) (lambda (eta-0) (PreludeC-45Types-isDigit eta-0)) (PreludeC-45Types-fastUnpack arg-0)))) (cond ((equal? sc0 1) (box (vector 0 (cast-string-int arg-0)))) (else '())))))))
(define StackIO-doAdd (vector 6 (vector 1 ) (lambda (u--val1) (vector 6 (vector 1 ) (lambda (u--val2) (vector 0 (+ u--val2 u--val1)))))))
...
(define StackIO-tryAdd (lambda (arg-0) (cond ((equal? arg-0 0) (StackIOC-45StackDo-C-62C-62 (vector 4 "Fewer than two items on the stack\xa;") (lambda () (StackIO-stackCalc arg-0))))(else (let ((e-0 (- arg-0 1))) (cond ((equal? e-0 0) (StackIOC-45StackDo-C-62C-62 (vector 4 "Fewer than two items on the stack\xa;") (lambda () (StackIO-stackCalc arg-0))))(else (let ((e-1 (- e-0 1))) (StackIOC-45StackDo-C-62C-62 StackIO-doAdd (lambda () (StackIOC-45StackDo-C-62C-62C-61 (vector 2 ) (lambda (u--result) (lambda () (StackIOC-45StackDo-C-62C-62 (vector 4 (string-append (PreludeC-45Show-u--show_Show_Integer u--result) "\xa;")) (lambda () (StackIO-stackCalc (+ e-1 1)))))))))))))))))
(define StackIO-doDiscard (vector 1 ))
(define StackIO-tryDiscard (lambda (arg-0) (cond ((equal? arg-0 0) (StackIOC-45StackDo-C-62C-62 (vector 4 "No items on the stack\xa;") (lambda () (StackIO-stackCalc arg-0))))(else (let ((e-0 (- arg-0 1))) (StackIOC-45StackDo-C-62C-62C-61 StackIO-doDiscard (lambda (u--result) (lambda () (StackIOC-45StackDo-C-62C-62 (vector 4 (string-append "Discarded " (string-append (PreludeC-45Show-u--show_Show_Integer u--result) "\xa;"))) (lambda () (StackIO-stackCalc e-0)))))))))))
(define StackIO-doDuplicate (vector 6 (vector 2 ) (lambda (u--val) (vector 0 u--val))))
(define StackIO-tryDuplicate (lambda (arg-0) (cond ((equal? arg-0 0) (StackIOC-45StackDo-C-62C-62 (vector 4 "No items on the stack\xa;") (lambda () (StackIO-stackCalc arg-0))))(else (let ((e-0 (- arg-0 1))) (StackIOC-45StackDo-C-62C-62 StackIO-doDuplicate (lambda () (StackIOC-45StackDo-C-62C-62C-61 (vector 2 ) (lambda (u--result) (lambda () (StackIOC-45StackDo-C-62C-62 (vector 4 (string-append "Duplicated " (string-append (PreludeC-45Show-u--show_Show_Integer u--result) "\xa;"))) (lambda () (StackIO-stackCalc (+ (+ e-0 1) 1))))))))))))))
(define StackIO-doMultiply (vector 6 (vector 1 ) (lambda (u--val1) (vector 6 (vector 1 ) (lambda (u--val2) (vector 0 (* u--val2 u--val1)))))))
(define StackIO-tryMultiply (lambda (arg-0) (cond ((equal? arg-0 0) (StackIOC-45StackDo-C-62C-62 (vector 4 "Fewer than two items on the stack\xa;") (lambda () (StackIO-stackCalc arg-0))))(else (let ((e-0 (- arg-0 1))) (cond ((equal? e-0 0) (StackIOC-45StackDo-C-62C-62 (vector 4 "Fewer than two items on the stack\xa;") (lambda () (StackIO-stackCalc arg-0))))(else (let ((e-1 (- e-0 1))) (StackIOC-45StackDo-C-62C-62 StackIO-doMultiply (lambda () (StackIOC-45StackDo-C-62C-62C-61 (vector 2 ) (lambda (u--result) (lambda () (StackIOC-45StackDo-C-62C-62 (vector 4 (string-append (PreludeC-45Show-u--show_Show_Integer u--result) "\xa;")) (lambda () (StackIO-stackCalc (+ e-1 1)))))))))))))))))
(define StackIO-doNegate (vector 6 (vector 1 ) (lambda (u--val) (vector 0 (- 0 u--val)))))
(define StackIO-tryNegate (lambda (arg-0) (cond ((equal? arg-0 0) (StackIOC-45StackDo-C-62C-62 (vector 4 "No items on the stack\xa;") (lambda () (StackIO-stackCalc arg-0))))(else (let ((e-0 (- arg-0 1))) (StackIOC-45StackDo-C-62C-62 StackIO-doNegate (lambda () (StackIOC-45StackDo-C-62C-62C-61 (vector 2 ) (lambda (u--result) (lambda () (StackIOC-45StackDo-C-62C-62 (vector 4 (string-append (PreludeC-45Show-u--show_Show_Integer u--result) "\xa;")) (lambda () (StackIO-stackCalc (+ e-0 1))))))))))))))
(define StackIO-stackCalc (lambda (arg-0) (StackIOC-45StackDo-C-62C-62 (vector 4 "> ") (lambda () (StackIOC-45StackDo-C-62C-62C-61 (vector 3 ) (lambda (u--input) (let ((sc0 (StackIO-strToInput u--input))) (if (null? sc0) (lambda () (StackIOC-45StackDo-C-62C-62 (vector 4 "Invalid input\xa;") (lambda () (StackIO-stackCalc arg-0)))) (let ((e-2 (unbox sc0))) (case (vector-ref e-2 0) ((0) (let ((e-3 (vector-ref e-2 1))) (lambda () (StackIOC-45StackDo-C-62C-62 (vector 0 e-3) (lambda () (StackIO-stackCalc (+ arg-0 1))))))) ((1) (lambda () (StackIO-tryAdd arg-0))) ((2) (lambda () (StackIO-trySubtract arg-0))) ((3) (lambda () (StackIO-tryMultiply arg-0))) ((4) (lambda () (StackIO-tryNegate arg-0))) ((5) (lambda () (StackIO-tryDiscard arg-0))) (else (lambda () (StackIO-tryDuplicate arg-0)))))))))))))
(define StackIO-trySubtract (lambda (arg-0) (cond ((equal? arg-0 0) (StackIOC-45StackDo-C-62C-62 (vector 4 "Fewer than two items on the stack\xa;") (lambda () (StackIO-stackCalc arg-0))))(else (let ((e-0 (- arg-0 1))) (cond ((equal? e-0 0) (StackIOC-45StackDo-C-62C-62 (vector 4 "Fewer than two items on the stack\xa;") (lambda () (StackIO-stackCalc arg-0))))(else (let ((e-1 (- e-0 1))) (StackIOC-45StackDo-C-62C-62 StackIO-doSubtract (lambda () (StackIOC-45StackDo-C-62C-62C-61 (vector 2 ) (lambda (u--result) (lambda () (StackIOC-45StackDo-C-62C-62 (vector 4 (string-append (PreludeC-45Show-u--show_Show_Integer u--result) "\xa;")) (lambda () (StackIO-stackCalc (+ e-1 1)))))))))))))))))
(define StackIO-runStack (lambda (arg-3 arg-4) (case (vector-ref arg-4 0) ((0) (let ((e-26 (vector-ref arg-4 1))) (lambda (eta-0) (cons (vector 0 ) (cons e-26 arg-3)))))(else (lambda (clam-0) (if (null? arg-3) (case (vector-ref arg-4 0) ((3) (let ((act-1 (PreludeC-45IO-prim__getStr clam-0))) (cons act-1 arg-3))) ((4) (let ((e-2 (vector-ref arg-4 1))) (let ((act-1 (PreludeC-45IO-prim__putStr e-2 clam-0))) (cons (vector 0 ) arg-3)))) ((5) (let ((e-5 (vector-ref arg-4 1))) (cons e-5 arg-3))) ((6) (let ((e-11 (vector-ref arg-4 1))) (let ((e-12 (vector-ref arg-4 2))) (let ((act-1 ((StackIO-runStack arg-3 e-11) clam-0))) (let ((e-2 (car act-1))) (let ((e-3 (cdr act-1))) ((StackIO-runStack e-3 (e-12 e-2)) clam-0))))))) (else (let ((e-17 (vector-ref arg-4 1))) (let ((e-18 (vector-ref arg-4 2))) (let ((act-1 ((StackIO-runStack arg-3 e-17) clam-0))) (let ((e-3 (cdr act-1))) ((StackIO-runStack e-3 (e-18)) clam-0))))))) (let ((e-21 (car arg-3))) (let ((e-22 (cdr arg-3))) (case (vector-ref arg-4 0) ((1) (cons e-21 e-22)) ((2) (cons e-21 (cons e-21 e-22)))(else (case (vector-ref arg-4 0) ((3) (let ((act-1 (PreludeC-45IO-prim__getStr clam-0))) (cons act-1 arg-3))) ((4) (let ((e-2 (vector-ref arg-4 1))) (let ((act-1 (PreludeC-45IO-prim__putStr e-2 clam-0))) (cons (vector 0 ) arg-3)))) ((5) (let ((e-5 (vector-ref arg-4 1))) (cons e-5 arg-3))) ((6) (let ((e-11 (vector-ref arg-4 1))) (let ((e-12 (vector-ref arg-4 2))) (let ((act-1 ((StackIO-runStack arg-3 e-11) clam-0))) (let ((e-2 (car act-1))) (let ((e-3 (cdr act-1))) ((StackIO-runStack e-3 (e-12 e-2)) clam-0))))))) (else (let ((e-17 (vector-ref arg-4 1))) (let ((e-18 (vector-ref arg-4 2))) (let ((act-1 ((StackIO-runStack arg-3 e-17) clam-0))) (let ((e-3 (cdr act-1))) ((StackIO-runStack e-3 (e-18)) clam-0)))))))))))))))))
(define StackIO-run (lambda (arg-1 arg-2 arg-3 ext-0) (if (null? arg-1) (vector 0 ) (let ((e-0 (unbox arg-1))) (case (vector-ref arg-3 0) ((0) (let ((e-4 (vector-ref arg-3 1))) (let ((e-5 (vector-ref arg-3 2))) (let ((act-1 ((StackIO-runStack arg-2 e-4) ext-0))) (let ((e-2 (car act-1))) (let ((e-3 (cdr act-1))) (StackIO-run (e-0) e-3 ((e-5 e-2)) ext-0))))))) (else (let ((e-8 (vector-ref arg-3 1))) (let ((e-9 (vector-ref arg-3 2))) (let ((act-1 ((StackIO-runStack arg-2 e-8) ext-0))) (let ((e-3 (cdr act-1))) (StackIO-run (e-0) e-3 (e-9) ext-0)))))))))))
(define StackIO-forever (lambda () (box (lambda () (StackIO-forever)))))
(define StackIO-main (lambda (ext-0) (StackIO-run (StackIO-forever) '() (StackIO-stackCalc 0) ext-0)))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (StackIO-main eta-0)))
  (collect 4)
